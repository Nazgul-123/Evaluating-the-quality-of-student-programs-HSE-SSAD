...
*4. MVP. Minimum viable product (минимально жизнеспособный продукт)*
Данный проект состоит из нескольких взаимосвязанных компонентов: ML-моделей, бизнес-логики, интерфейса (Telegram-бот) и внешних интеграций (GitHub).  
Отказ:
-Высокая техническая сложность системы
-Многокомпонентная архитектура с ML-моделями, бизнес-логикой, интеграциями
-Риск создания некачественного продукта при попытке быстрой реализации
-Необходимость глубокой проработки каждого компонента
-Сложность интеграционных решений, точнее комплексное взаимодействие с GitHub, Telegram, должно работать и минимальный продукт может не покрывать потребности пользователей
